...
/**
 * KJV 串珠素材（bible-cross-references 的 crossreferences_kjv.tsv）书卷缩写 → 标准 id。
 * 缩写为 KJV 标准形式（如 Gen/Ps/1 Cor/Rev），用于解析串珠引用目标。
 */
export const KJV_ABBR = {
  Gen: '01', Exod: '02', Lev: '03', Num: '04', Deut: '05', Josh: '06', Judg: '07', Ruth: '08',
  '1 Sam': '09', '2 Sam': '10', '1 Kgs': '11', '2 Kgs': '12', '1 Chr': '13', '2 Chr': '14',
  ...
  '1 Thess': '52', '2 Thess': '53', '1 Tim': '54', '2 Tim': '55', Titus: '56', Phlm: '57',
  Heb: '58', Jas: '59', '1 Pet': '60', '2 Pet': '61', '1 John': '62', '2 John': '63', '3 John': '64',
  Jude: '65', Rev: '66',
}
