...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/persons', name: 'persons', component: () => import('../views/persons/PersonsPage.vue') },
    { path: '/persons/:id', name: 'person-detail', component: () => import('../views/persons/PersonsPage.vue') },
    { path: '/events', name: 'events', component: () => import('../views/events/EventsPage.vue') },
    { path: '/events/:id', name: 'event-detail', component: () => import('../views/events/EventsPage.vue') },
    { path: '/prophecies', name: 'prophecies', component: () => import('../views/prophecies/PropheciesPage.vue') },
    { path: '/prophecies/:id', name: 'prophecy-detail', component: () => import('../views/prophecies/PropheciesPage.vue') },
    { path: '/strongs', name: 'strongs', component: () => import('../views/strongs/StrongDictPage.vue') },
    { path: '/strongs/:code', name: 'strong-detail', component: () => import('../views/strongs/StrongDictPage.vue') },
